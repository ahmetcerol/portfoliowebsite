    ...
    <Container id="projects">
      <Wrapper>
        ...
        <ToggleButtonGroup >
          ...
          <Divider />
          {toggle === 'winform app' ?
            <ToggleButton active value="winform app" onClick={() => setToggle('winform app')}>Windows Form Application </ToggleButton>
            :
            <ToggleButton value="winform app" onClick={() => setToggle('winform app')}>Windows Form Application</ToggleButton>
          }
        </ToggleButtonGroup>
        <CardContainer>
          {toggle === 'all' && projects
